...
export const locations = {
  westlake: {
    ...
    poiData: [
      ...
      { id: 'leifeng-sunset', name: '雷峰夕照', icon: '🏯', position: { x: 0.42, y: 0.78 }, distance: '800m', narration: '前方那座飞檐翘角的宝塔便是雷峰塔。民间传说中，法海将白娘子镇压于此。每当夕阳西下，落日余晖为塔身镀上一层金轮，便是著名的雷峰夕照。', image: 'https://picsum.photos/id/35/400/240' },
      { id: 'three-pools', name: '三潭印月', icon: '🏮', position: { x: 0.42, y: 0.55 }, distance: '600m', narration: '水面上的三座石塔，便构成了三潭印月之景，您手中的一元人民币背面正是此番胜景。每至中秋佳节，塔中燃灯，湖面交辉，光影片片，引人入胜。', image: 'https://picsum.photos/id/36/400/240' },
      { id: 'flower-harbor', name: '花港观鱼', icon: '🐟', position: { x: 0.30, y: 0.68 }, distance: '700m', narration: '我们正身处花港观鱼。此处池水清鉴，数千尾红锦鲤游曳其间，聚散落英。赏花观鱼、亲近自然，不妨在此静赏南宋诗画中的闲适与清幽。', image: 'https://picsum.photos/id/39/400/240' },
      { id: 'oriole-singing', name: '柳浪闻莺', icon: '🐦', position: { x: 0.60, y: 0.72 }, distance: '850m', narration: '这里是柳浪闻莺，昔日南宋御花园的旧址。微风过处，枝头黄莺啼鸣婉转。暮春时节，漫天柳絮轻舞飞扬，最能体会烟雨江南的缱绻柔情。', image: 'https://picsum.photos/id/40/400/240' },
      { id: 'autumn-moon', name: '平湖秋月', icon: '🌙', position: { x: 0.52, y: 0.25 }, distance: '300m', narration: '这是西湖绝佳的赏月胜地——平湖秋月。每逢金秋之夜，皓月当空，湖面如镜，天上月与水中月交相辉映，正可谓“万顷湖平长似镜，四时月好最宜秋”。', image: 'https://picsum.photos/id/41/400/240' },
      { id: 'double-peaks', name: '双峰插云', icon: '⛰️', position: { x: 0.18, y: 0.30 }, distance: '1.2km', narration: '远眺天际，那巍然耸立的便是南高峰与北高峰，合称双峰插云。晴日里双峰入群霄，烟雨中则若隐若现、宛如仙境。若得空登临峰顶，西湖全景便可尽收眼底。', image: 'https://picsum.photos/id/42/400/240' },
      { id: 'nanping-bell', name: '南屏晚钟', icon: '🔔', position: { x: 0.48, y: 0.85 }, distance: '900m', narration: '您听，这是净慈寺传来的钟声。每逢向晚，雄浑悠远的钟声在南屏山谷间回荡，让人心生宁静。新元之夜，此处常有撞钟祈福之典，愿能为您涤去几分尘嚣。', image: 'https://picsum.photos/id/43/400/240' },
      { id: 'lingyin-temple', name: '曲院风荷', icon: '🪷', position: { x: 0.32, y: 0.22 }, distance: '400m', narration: '来到曲院风荷，炎夏时节满池接天莲叶，清风徐来，暗香浮动。南宋时此地本是皇家酿酒坊，酒香与荷香交织，是以得名“曲院”，别有一番醉人韵味。', image: 'https://picsum.photos/id/44/400/240' }
    ],
    aiResponses: {
  ...
  gugong: {
    ...
    poiData: [
      ...
      { id: 'jingyang', name: '景阳宫', icon: '🏛️', position: { x: 0.7, y: 0.35 }, distance: '500m', narration: '步入东六宫之一的景阳宫，便远离了中轴线的喧嚣。在此您可以放慢脚步，静赏古建筑的红墙黄瓦，体味岁月沉淀下的深宫幽静。', image: 'https://picsum.photos/id/67/400/240' }
    ],
    aiResponses: {
